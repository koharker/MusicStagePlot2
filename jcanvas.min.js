...
(function(k,w,o,u,C,c,t,m){
    var p,j,n=k.fn,l=k.extend,D=o.PI,E=o.round,a=o.sin,e=o.cos,h=k.event.fix,b,d;
    function A(G){
        if(!G){
            j=s.prototype=l({},p)
        }else{
